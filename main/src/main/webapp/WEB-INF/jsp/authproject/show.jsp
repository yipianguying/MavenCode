...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">众筹平台 - 项目审核</a></div>
        </div>
                    ...
                    <div class="panel-body">
                        <form>
                            <div class="form-group">
                                <label for="fname" >项目名称</label>
                                ${project.name }
                            </div>
                            <div class="form-group">
                                <label for="fremark">项目简介</label>
                                ${project.remark }
                            </div>
                            <div class="form-group">
                                <label for="fmoney">项目金额</label><br>
                                ${project.money }
                            </div>
...
<script type="text/javascript">
    ...
    $("#passBtn").click(function(){
        $.ajax({
            type : "POST",
            url  : "${APP_PATH}/authproject/pass.do",
            data : {
                id : "${param.id}",
                status: "2"
            },
    ...
    $("#refuseBtn").click(function(){
        $.ajax({
            type : "POST",
            url  : "${APP_PATH}/authproject/refuse.do",
            data : {
                id : "${param.id}",
                status: "3"
            },
