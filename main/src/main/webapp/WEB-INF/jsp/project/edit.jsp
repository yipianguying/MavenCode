				...
				<form id="updateForm">
				  ...
				  <div class="form-group">
                   ...
                   <div class="form-group">
                     ...
                     <input type="number" class="form-control" id="money" value="${project.money }" placeholder="请输入项目金额">
                   </div>
            	...
            	$("#updateBtn").click(function(){
                	...
                	$.ajax({
                		...
                		success : function(result){
                			...
                			if(result.success){
                				layer.msg("项目数据修改成功", {time:1000, icon:6});
                				window.location.href="${APP_PATH}/project/index.htm";
                			}else{
                				layer.msg("项目数据修改失败", {time:1000, icon:5, shift:6});
                			} 			
                			
                		},
                		error : function(){
                			layer.msg("项目数据修改失败", {time:2000, icon:5, shift:6});
                		}
