                            ...
                            <tr >
                                <td colspan="6" align="center">
                                    <ul class="pagination">
                                        ...
                                        <c:if test="${page.pageNumber!=1 }">
                                            <li><a href="#" onclick="pageChange(${page.pageNumber-1})">上一页</a></li>
                                        </c:if>
                                        <%-- 当前页   --%>
                                        <c:forEach begin="1" end="${page.totalNumber }" var="num">
                                            <li
                                        ...
                                        <%--    下一页的导航--%>
                                        <c:if test="${page.pageNumber==page.totalNumber }">
                                            <li class="disabled"><a href="#">下一页</a></li>
                                        </c:if>
                                        <c:if test="${page.pageNumber!=page.totalNumber}">
                                            <li><a href="#" onclick="pageChange(${page.pageNumber+1})">下一页</a></li>
                                        </c:if>
                                    </ul>
                                </td>
                            </tr>
