...
<div class="container">
    <form id="loginForm" action="${APP_PATH}/login.do" method="post" class="form-signin" role="form">
        ...
        <div class="checkbox">
            ...
            <label style="float:right">
                <a href="${APP_PATH}/registerUser.htm">我要注册</a>
            </label>
        </div>
    ...
    function dologin() {
        ...
        var flag =  $("#rememberMe")[0].checked;
         $.ajax({
             ...
             success : function(result) {
                ...
                if(result.success) {
                    if("member" == result.data) {
                        ...
                        window.location.href = "${APP_PATH}/admin.htm";
                    } else {
                        layer.msg("登录失败,类型错误!",{time:1000, icon:5, shift:6});
                    }
             ...
             // 出现异常
             error:function () {
                 layer.msg("登录错误!",{time:1000, icon:5, shift:6});
             }
         });
        // $("#loginForm").submit();
