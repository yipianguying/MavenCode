        ...
        <div class="col-sm-3 col-md-3 column">
                ...
                <div class="col-md-12">
                    <div class="thumbnail" style="    border-radius: 0px;">
                        ...
                        <div class="caption" style="text-align:center;">
                            <h3>
                                <%--取出账号--%>
                                ${sessionScope.memberLogin.loginacct }
                            </h3>
                            <%--判读会员处于什么状态--%>
                            <c:choose>
                                <c:when test="${memberLogin.authstatus eq '1'}">
                                    <span class="label label-warning" style="cursor:pointer;">实名认证申请中</span>
                                </c:when>
                                <c:when test="${memberLogin.authstatus eq '2'}">
            ...
            <div class="list-group">
                ...
                <div class="list-group-item " style="cursor:pointer;"
                     onclick="window.location.href='${APP_PATH}/member/mineCrowdFunding.htm'">
