...
<%--        <form class="form-inline" role="form" style="float:left;">
          ...
          <button type="button" class="btn btn-warning" onclick="queryAuthcert()">
            		...
            		success : function( result ) {
            			...
            			if ( result.success ) {
            				...
            				$.each(taskList, function(i, task){
                                ...
                                content += '  <td>';
                                content += '      <button type="button" onclick="window.location.href=\'${APP_PATH}/authcert/showMember.htm?taskid=' + task.taskid + '&memberid=' + task.member.id + '\'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
                                content += '  </td>';
                                content += '</tr>';
            				});  				       				
            				$("tbody").html(content);
